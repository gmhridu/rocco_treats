  ...
  return (
    <section className="py-16 md:py-24 lg:py-32 overflow-hidden bg-linear-to-b from-white to-[#faf6f6]">
      <div className="container mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-evenly gap-12 lg:gap-16">
          {/* Left: Text + Bubble */}
          <div className="relative flex flex-col items-center lg:items-start text-center lg:text-left">
            ...
            {/* Title */}
            <h1 className="font-heritage text-4xl font-bold uppercase tracking-tight text-[#C4797A] md:text-5xl">
              Your Partner In
          ...
          <Image
            ...
            width={800}
            height={600}
            className="w-full drop-shadow-xl h-auto"
            priority
          />
        </div>
      </div>
